    ...
    constructor(){
        ...
        this.state = {
            cocktails: [
                ...
                'description': 'Titos vodka or Boodles gin, choice of blue cheese olives or pimento olives'},
                ...
                {'name': 'Gin Rickey',
                 'description': 'Pier View, lime, rosemary honey syrup'},
                {'name': 'The eluM',
                 'description': 'Absolute Elyx vodka, lemon, lime, and grapefruit juice, Unity Vibration ginger kombucha beer'},
                {'name': 'La Paloma',
                 'description': 'Mi Campo tequila, pamplemousse, fresh grapefruit juice'},
                {'name': 'Cuban Mojito',
